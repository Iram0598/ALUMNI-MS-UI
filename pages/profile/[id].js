              ...
              <Card>
                ...
                <div className="d-flex ms-5">
                  <div className="me-5">
                    ...
                    <h5 style={{ marginTop: "29px" }}>Program:</h5>
                    <h5 style={{ marginTop: "29px" }}>Gender:</h5>
                    <h5 style={{ marginTop: "29px" }}>Year of admission:</h5>
                    <h5 style={{ marginTop: "29px" }}>Present address:</h5>
